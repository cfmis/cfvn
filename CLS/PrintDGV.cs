    ...
    class PrintDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                ppvw.PrintPreviewControl.Zoom = 1.0; //默認預監頁面為100% ADD BY 2018-05-12
                (ppvw as Form).WindowState = FormWindowState.Maximized; //预览窗体加载时最大化 ADD BY 2018-05-12
        ...
        private static void DrawFooter(System.Drawing.Printing.PrintPageEventArgs e, int RowsPerPage)
        {
            ...
            //                + " 頁";
            string PageNum = String.Format(" Page {0} of {1} ", PageNo, Math.Ceiling((double)(cnt / RowsPerPage)));
