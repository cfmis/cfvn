...
namespace cfvn
{
    class AccessHelper
    {
        ...
        public AccessHelper()
        {
            ...
            conn_str = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\cfvn\db\daan.mdb;Jet OLEDB:Database Password=8888";
            InitDB();
        }
        ...
        public DataTable GetDataTable(string strSql)
        {
            ...
            try
            {
                ...
                //dt.Clear();
                OleDbDataAdapter da = new OleDbDataAdapter(strSql, ole_connection);
                da.Fill(dt);
                da.Dispose();
            }
