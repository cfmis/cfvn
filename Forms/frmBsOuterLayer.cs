...
{
    public partial class frmBsOuterLayer : DockContent
    {
        ...
        private void frmBsOuterLayer_Load(object sender, EventArgs e)
        {  
            Load_Date();
            //系統狀態
        ...
        {
            dtDetail.Clear();           
            const string sql = @"SELECT * From bs_outer with(nolock) Where state='0'";
        ...
        private void frmBsOuterLayer_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
