...
{
    public partial class frmBsTaxKind : DockContent
    {
        ...
        private void frmBsTaxKind_Load(object sender, EventArgs e)
        {
            ...
            txttax_rate.DataBindings.Add("Text", bds1, "tax_rate");
        ...
        {
            dtDetail.Clear();
            const string sql = @"SELECT * From bs_tax_kind with(nolock) Where state='0' ORDER BY id";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (flag_datavalid)
            {
                MessageBox.Show("Tax Kind id cannot be empty !", myMsg.msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void frmBsTaxKind_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
