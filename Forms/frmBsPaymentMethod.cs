...
{
    public partial class frmBsPaymentMethod : DockContent
    {
        ...
        private void frmBsPaymentMethod_Load(object sender, EventArgs e)
        {
        ...
        {
            dtDetail.Clear();
            const string sql = @"SELECT * From bs_payment_method with(nolock) Where state='0'";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (flag_datavalid)
            {
                MessageBox.Show("Payment Method id cannot be empty !", myMsg.msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void frmBsPaymentMethod_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
