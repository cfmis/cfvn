...
{
    public partial class frmBsShippingMode : DockContent
    {
        ...
        private void frmBsShippingMode_Load(object sender, EventArgs e)
        {
        ...
        {
            dtDetail.Clear();
            const string sql = @"SELECT * From bs_shipping_mode with(nolock) Where state='0' order by id";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (flag_datavalid)
            {
                MessageBox.Show("Shipping mode id cannot be empty !", myMsg.msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void frmBsShippingMode_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
