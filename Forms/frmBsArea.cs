...
{
    public partial class frmBsArea : DockContent
    {
        ...
        private void frmBsArea_Load(object sender, EventArgs e)
        {  
            Load_Date();
            //系統狀態
        ...
        {
            dtDetail.Clear();           
            const string sql = @"SELECT * From bs_area with(nolock) Where state='0'";
        ...
        private void frmBsArea_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
