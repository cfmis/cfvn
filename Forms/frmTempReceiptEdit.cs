...
{
    public partial class frmTempReceiptEdit : Form
    {
        string m_state = "", m_id = "", m_bill_origin_id;
        frmTempReceipt myParentForm;
        public clsAppPublic objPub = new clsAppPublic();

        DataTable dtMM = new DataTable();
        public frmTempReceiptEdit(frmTempReceipt frmParent, string edit_status, string id,string bill_type )
        {
            InitializeComponent();
            ...
            bdnav.BindingSource = frmTempReceipt.bds_d;
            clsTranslate obj_ctl = new clsTranslate( this.Controls, DBUtility._language);
            obj_ctl.Translate();
        }

        private void frmTempReceiptEdit_Load(object sender, EventArgs e)
        {
            //數量單位
        ...
        private void frmTempReceiptEdit_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Input_qty()
        {
            ...
            {
                frmTempReceipt.bds_d.EndEdit();
                DataRow drw = ((DataRowView)frmTempReceipt.bds_d.Current).Row;
                if (m_bill_origin_id == "2")
                {                    
