...
{
    public partial class frmBsPaymentCondition : DockContent
    {
        ...
        private void frmBsPaymentCondition_Load(object sender, EventArgs e)
        {  
            Load_Date();
            //系統狀態
        ...
        {
            dtDetail.Clear();           
            const string sql = @"SELECT * From bs_payment_condition with(nolock) Where state='0'";
        ...
        private void frmBsPaymentCondition_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
