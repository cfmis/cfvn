...
{
    public partial class frmBsZone : DockContent
    {
        ...
        private void frmBsZone_Load(object sender, EventArgs e)
        {  
            Load_Date();
            //系統狀態
        ...
        {
            dtDetail.Clear();           
            const string sql = @"SELECT * From bs_zone with(nolock) Where state='0'";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (flag_datavalid)
            {
                MessageBox.Show("Zone id cannot be empty !", myMsg.msgTitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void frmBsZone_FormClosed(object sender, FormClosedEventArgs e)
        {
           dtDetail=null ;
           SDA = null;
           conn.Close();
